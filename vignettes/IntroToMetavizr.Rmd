...
ic_plot <- app$plot(splinesMRexp[splines_to_plot_indices,], type = "LeafCounts", datasource_name = "etec16_base21", control=metavizControl(norm = FALSE, aggregateAtDepth = 4), feature_order = feature_order2)
