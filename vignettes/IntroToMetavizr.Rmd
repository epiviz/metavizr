...
splinesMRexp <- ts2MRexperiment(timeSeriesFits, featureData = featureData(aggregateByTaxonomy(etec16s, lvl="Species", featureOrder = feature_order2)), sampleNames = timeSeriesFits[[2]]$fit$timePoints)
```
