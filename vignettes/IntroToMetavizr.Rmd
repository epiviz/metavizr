...
ic_plot <- app$plot(splinesMRexp[splines_to_plot_indices,], datasource_name = "etec16_base21", type = "LeafCounts", control=metavizControl(norm = FALSE, aggregateAtDepth = 4), feature_order = feature_order2)
splineObj <- app$data_mgr$add_measurements(splinesMRexp[splines_to_plot_indices,], datasource_name = "splines2", type = "LeafCounts", control = metavizControl(norm=FALSE, aggregateAtDepth = 4), feature_order = feature_order2)
