...
```{r, eval=TRUE}
heatmap <- app$chart_mgr$revisualize(chartType = "HeatmapPlot", chart = icicle_plot)
```
...
```{r, eval=TRUE}
stackedPlot <- app$chart_mgr$revisualize(chartType ="StackedLinePlot", chart = icicle_plot)
```
